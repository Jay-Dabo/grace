  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created church as @church" do
        post :create, {:church => valid_attributes}, valid_session
        expect(assigns(:church)).to be_a(Church)
        expect(assigns(:church)).to be_persisted
      end

      it "redirects to the created church" do
        post :create, {:church => valid_attributes}, valid_session
        expect(response).to redirect_to(Church.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved church as @church" do
        post :create, {:church => invalid_attributes}, valid_session
        expect(assigns(:church)).to be_a_new(Church)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested church" do
        church = Church.create! valid_attributes
        put :update, {:id => church.to_param, :church => new_attributes}, valid_session
        church.reload
    ...
    context "with invalid params" do
      it "assigns the church as @church" do
        church = Church.create! valid_attributes
        put :update, {:id => church.to_param, :church => invalid_attributes}, valid_session
        expect(assigns(:church)).to eq(church)
      end
